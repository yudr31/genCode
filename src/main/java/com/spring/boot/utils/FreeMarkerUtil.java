...
public class FreeMarkerUtil {
    ...
    public static String getContext(Object tableInfo,String modelName,String modelContext){
        fragmentTemplateService = SpringUtil.getBean(FragmentTemplateService.class);
        List<FragmentTemplate> fragmentTemplateList = fragmentTemplateService.getFragmentTemplateList();
