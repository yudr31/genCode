...
/**
 * @author yuderen
 * @version 2017/11/21 11:06
 */
@Aspect
@Component
public class AddParamInterceptor {

    @AfterReturning(returning = "object", pointcut = "execution(public * com.spring.boot.controller.*Controller.*(..))")
    public Object testAddParam(Object object){
